        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <div className="relative max-w-4xl mx-auto">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1649783467344-4dfdb3b55036?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMGdlb21ldHJpYyUyMG1pbmltYWwlMjB2ZWN0b3J8ZW58MXx8fHwxNzU3ODUzMTE0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
      ...
      <section className="py-20 px-6 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            {/* Connection Lines */}
            <div className="hidden md:block absolute top-24 left-1/3 right-1/3 h-0.5 bg-gradient-to-r from-orange-300 via-teal-300 to-purple-300" />
            ...
            >
              ...
              <h3 className="text-xl mb-4">Design Your Brand</h3>
              <p className="text-muted-foreground leading-relaxed">
                Start with Logora to create your visual identity. Design logos, 
                choose colors, and establish your brand foundation.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center relative"
            >
              <div className="w-20 h-20 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-6 relative z-10">
                <div className="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center">
                  <span className="text-white">2</span>
                </div>
              </div>
              <h3 className="text-xl mb-4">Present Your Vision</h3>
              <p className="text-muted-foreground leading-relaxed">
                Use Deckr to craft compelling presentations. Tell your story, 
                pitch ideas, and communicate your vision effectively.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center relative"
            >
              <div className="w-20 h-20 bg-gradient-to-br from-purple-100 to-blue-100 rounded-full flex items-center justify-center mx-auto mb-6 relative z-10">
                <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center">
                  <span className="text-white">3</span>
                </div>
              </div>
              <h3 className="text-xl mb-4">Build & Deploy</h3>
              <p className="text-muted-foreground leading-relaxed">
                Bring it to life with Buidl. Develop applications, deploy to production, 
                and scale your ideas into reality.
              </p>
            </motion.div>
          </div>
        </div>
